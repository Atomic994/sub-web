                ...
                <el-form-item label-width="0px">
                  <el-row type="flex">
                    ...
                    <el-popover placement="bottom" v-model="form.extraset">                     
						...
						<el-col :span="12"><el-checkbox v-model="form.xudp" label="启用 XUDP"></el-checkbox></el-col>                        
						</el-row>
						<el-row :gutter="10">
...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
			"本站自建后端": "https://api.honyin.cf/sub?",
			"sub作者&lhie1提供-稳定": "https://api.dler.io/sub?",
			"subconverter作者提供-稳定":"https://sub.xeton.dev/sub?",
			"sub-web作者提供-稳定": "https://api.wcc.best/sub?",
			"肥羊后端提供-稳定": "https://api.v1.mk/sub?",			
        },
		backendOptions: [
			{ value: "https://api.honyin.cf/sub?" },
        ...
        remoteConfig: [
          {
            label: "sub.honyin.cf本站提供",
            options: [
              {
                label: "No-Urltest",
                value:
                  "https://raw.githubusercontent.com/Atomic994/subconverter/master/base/config/MY.ini"
              },
              {
                label: "Urltest",
                value:
                  "https://raw.githubusercontent.com/Atomic994/subconverter/master/base/config/MY_QuanX.ini"
              }
            ]
          },
          {
  ...
  mounted() {
    ...
    this.form.remoteConfig = "https://raw.githubusercontent.com/Atomic994/subconverter/master/base/config/MY.ini";
